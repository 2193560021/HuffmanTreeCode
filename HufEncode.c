...
int CrtHuffmanTree(HuffmanTree ht, int tag) //ctrhuffman
{
    n = 0;
    num = 0;
    int m, s1, s2;
...
int Encoding(HuffmanTree ht, int tag) //
{
    printf("\n\t\tThe HuffmanCode:\n");
    FILE *fp, *fp1;
    int j = 0;
...
int Decoding(HuffmanTree ht, int tag) //
{
    int i = 0;
    int j = 2 * n - 1;
    FILE *fp, *fp2;
